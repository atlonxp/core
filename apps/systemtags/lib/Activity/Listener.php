	...
	public function event(ManagerEvent $event) {
		...
		if ($event->getEvent() === ManagerEvent::EVENT_CREATE) {
			$genericEvent = new GenericEvent(null,
				['subject' => Extension::CREATE_TAG,
					'actor' => $actor,
					'newTag' => $event->getTag()->getName()]);
			...
			$genericEvent = new GenericEvent(null,
				['subject' => Extension::UPDATE_TAG,
					'actor' => $actor,
					'newTag' => $event->getTag()->getName(), 'previousTag' => $event->getTagBefore()->getName()]);
			...
			$genericEvent = new GenericEvent(null,
				['subject' => Extension::DELETE_TAG,
					'actor' => $actor,
					'removeTag' => $event->getTag()->getName()]);
